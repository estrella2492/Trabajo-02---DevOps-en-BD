...
\subsection{\textbf{DevOps para lograr innovación}}
La tecnología por sí sola no ofrece una ventaja competitiva. Sin embargo, la entrega de innovación basada en tecnología puede hacer que una organización se diferencie positivamente del resto.
La innovación implica desarrollar continuamente nuevas ideas para innovar el software, lo que a su vez mejora continuamente el valor que se entrega a los usuarios. DevOps consiste en una colaboración máxima entre todos los participantes: no sólo entre desarrollo y operaciones sino también en todas las líneas de negocios, los proveedores de software y los propios consumidores. DevOps ofrece una ventaja competitiva debido a que permite:
\begin{itemize}
\item Acelerar la innovación continua de ideas habilitando la colaboración en el desarrollo y las pruebas en toda la cadena de valor.
\item Brindar una entrega continua de estas innovaciones automatizando los procesos de entrega del software y eliminando los desperdicios, siempre en conformidad con los requisitos regulatorios
\item Brindar un ciclo de retroalimentación para el aprendizaje continuo sobre los clientes, monitoreando y optimizando la innovación impulsada por software.
\end{itemize}
